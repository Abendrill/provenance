...
impl<Provenance: 'static, Value> SeparateProvenanceMap<Provenance, Value> {
    ...
    /// use provenance::{SeparateProvenanceMap, Key};
    ///
    /// #[derive(Debug)]
    /// struct ProvenanceA;
    ///
    ...
    ///     name: &'static str,
    ///     previous: Option<Key<ProvenanceA>>
    /// }
    ///
    /// #[derive(Debug)]
    /// struct Node {
    ///     name: &'static str,
    ///     previous: Key<ProvenanceB>,
    /// }
    ///
    /// let mut init_map = SeparateProvenanceMap::<ProvenanceA, _>::new().unwrap();
    ///
